...
import { WebAddressComponent } from 'app/entities/web-address/web-address.component';
...
describe('Component Tests', () => {
    describe('WebAddress Management Component', () => {
        let comp: WebAddressComponent;
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(WebAddressComponent, '')
                .compileComponents();
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.webAddresses[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });
